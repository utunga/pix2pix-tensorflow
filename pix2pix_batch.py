...
#delit_1024_train
#diffuse_to_normal_1024_model // NORMALS IN PREVIOUS FOLDER
#roughCombo_1024_train
#displaceCombo1024_train

parser = argparse.ArgumentParser()
parser.add_argument("--input_dir",  default="allExtent",  help="path to folder containing images")
parser.add_argument("--mode", default="test", choices=["train", "test", "export"])
parser.add_argument("--output_dir", default="outputDisp", help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default="displaceCombo1024_train", help="directory with checkpoint to resume training from or use for testing")
...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    layer_specs = [
        ...
        a.ngf * 32,  # encoder_10: [batch, 2, 2, ngf * 8] => [batch, 1, 1, ngf * 8]
    ]
    ...
    layer_specs = [
        ...
        (a.ngf * 8, 0.5),  # decoder_6: [batch, 16, 16, ngf * 8 * 2] => [batch, 32, 32, ngf * 8 * 2]
    ...
    # decoder_1: [batch, 512, 512, ngf * 2] => [batch, 1024, 1024, generator_outputs_channels]
